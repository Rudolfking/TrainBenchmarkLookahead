...
public class SignalNeighbor extends LookaheadTestCase
{
	...
	public void load() {
		...
		try {
			...
			lookahead.InitializeAll(SignalNeighborQuerySpecification.instance(), engine);
	...
	public void check() {
		...
		try 
		{
			res = lookahead.matchAll(engine, null, SignalNeighborQuerySpecification.instance(), null, null);
